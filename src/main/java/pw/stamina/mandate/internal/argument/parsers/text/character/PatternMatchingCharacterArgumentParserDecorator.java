 ...
 * @author Mark Johnson
 */
public final class PatternMatchingCharacterArgumentParserDecorator implements ArgumentParser<Character> {

    private final ArgumentParser<Character> backingParser;

    public PatternMatchingCharacterArgumentParserDecorator(final ArgumentParser<Character> backingParser) {
